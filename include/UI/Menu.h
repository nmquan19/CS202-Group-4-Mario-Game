...
class Parallelogram { // with two side parallel to x direction
private:
...
private:
    ...
    float spacing = 20.0f; // between 2 paral
...
public:
    ...
    void Init(int count, float y, float baseW, float h, Color c1, Color c2) {
