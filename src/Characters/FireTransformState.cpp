...
void FireTransformState::exit(Character* character) {
	...
	switch (character->characterType) {
	case CharacterType::MARIO:
		character->stateFrameData = Constants::Character::Mario::FIRE_FRAME_DATA;
		character->size = Constants::Character::Mario::SUPER_SIZE;
		break;
	case CharacterType::LUIGI:
		character->stateFrameData = Constants::Character::Luigi::FIRE_FRAME_DATA;
		character->size = Constants::Character::Luigi::SUPER_SIZE;
		break;
	case CharacterType::TOAD:
		character->stateFrameData = Constants::Character::Toad::FIRE_FRAME_DATA;
		character->size = Constants::Character::Toad::SUPER_SIZE;
		break;
	case CharacterType::TOADETTE:
		character->stateFrameData = Constants::Character::Toadette::FIRE_FRAME_DATA;
		character->size = Constants::Character::Toadette::SUPER_SIZE;
		break;
	}
